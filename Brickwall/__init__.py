...
class LocationRoutes(Resource):
    def get(self, location_id):
        ...
        return {"id": location_id, "name": retrieved_location.name}
...
class ReviewRoutes(Resource):
    def get(self, company_id, review_id):
        retrieved_review = JobReview.query.filter_by(id=review_id)
        return {
    ...
    @api.expect(JobReview.get_model(api))
    def post(self, review_id):
        req_data = request.get_json()
        retrieved_review = JobReview.query.filter_by(id=review_id).first()
